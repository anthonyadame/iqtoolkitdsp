...
namespace ODataGeneratedTests
{
    ...
    {
        private static IQDSP.OracleService service;
        ...
        {
            this.ctx = new DataServiceContext(new Uri(WcfTestUtil.ORAServiceRoot));
        }
        ...
        private static MethodInfo GetDefaultValueForTypeInnerMethod = typeof(OracleQueryTests).GetMethod("GetDefaultValueForTypeInner", BindingFlags.NonPublic | BindingFlags.Static);
