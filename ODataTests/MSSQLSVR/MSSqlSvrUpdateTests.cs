...
{
    [TestClass]
    public class MSSqlSvrUpdateTests
    {
        private IQDSP.MSSQLSVRService context;
        ...
        {
            this.context = new IQDSP.MSSQLSVRService(new Uri(WcfTestUtil.SQLServiceRoot, UriKind.Absolute));
        }
